...
# အပိုဆောင်းလမ်းညွှန် (၅) - စနစ်၏ ဖိုင်တည်ဆောက်ပုံ၊ ချိတ်ဆက်ပုံနှင့် အလုပ်လုပ်ပုံ (Architecture Overview)

ကျွန်ုပ်တို့ တည်ဆောက်ခဲ့သော Vaultwarden စနစ်ကြီးသည် အစိတ်အပိုင်း (၄) ခုဖြင့် ဖွဲ့စည်းထားပြီး၊ လုံခြုံရေးအမြင့်မားဆုံးဖြစ်စေရန် Docker Containers များအဖြစ် ခွဲခြားထားပါသည်။

### ၁။ စနစ်၏ ချိတ်ဆက်ပုံနှင့် အလုပ်လုပ်ပုံ (How it works)

- **User (သင်)** -> သင့်ဖုန်း/ကွန်ပျူတာရှိ Bitwarden App (သို့) Browser Extension မှတစ်ဆင့် `https://သင့်ဒိုမိန်း` သို့ လှမ်းချိတ်ဆက်သည်။
- **Cloudflare Tunnel (cloudflared)** -> သင်၏ ချိတ်ဆက်မှုကို Cloudflare က လက်ခံပြီး VPS ထဲရှိ `cloudflared` Container ထံသို့ လုံခြုံသော လိုဏ်ခေါင်း (Tunnel) မှတစ်ဆင့် ပို့ဆောင်ပေးသည်။ (ထို့ကြောင့် VPS ၏ IP အား သိစရာမလိုဘဲ ဖုံးကွယ်ထားနိုင်ပြီး၊ Firewall ဖွင့်စရာမလိုဘဲ လုံခြုံသွားသည်)။
- **Vaultwarden Server (vaultwarden)** -> `cloudflared` မှ ဝင်လာသော Data များကို Vaultwarden ပင်မစနစ်က လက်ခံရယူပြီး သိမ်းဆည်းပေး/ပြန်ထုတ်ပေးသည်။
- **Backup System (vaultwarden-backup)** -> နေ့စဉ် မနက် ၂ နာရီတိုင်းတွင် Vaultwarden ထဲရှိ Data အားလုံးကို Zip ဖိုင်အဖြစ် ပေါင်းချုပ်၊ Password ခတ်ပြီး Cloud (Koofr) ပေါ်သို့ အလိုအလျောက် တင်ပေးသည်။
- **Auto Updater (watchtower)** -> နေ့စဉ် စနစ်များကို စောင့်ကြည့်ပြီး Version အသစ်ထွက်ပါက အလိုအလျောက် Update ပြုလုပ်ပေးသည်။

### ၂။ ဖိုင်တည်ဆောက်ပုံ အနေအထား (File Structure)

VPS အတွင်းရှိ သင့် Home Folder အောက်တွင် `vaultwarden` ဆိုသော ဖိုင်တွဲတစ်ခု ရှိမည်ဖြစ်ပြီး ၎င်းအောက်တွင် အောက်ပါအတိုင်း ဖွဲ့စည်းထားပါသည် -

```text
~/vaultwarden/
├── docker-compose.yml       # စနစ်တစ်ခုလုံးကို မောင်းနှင်ပေးသော ပင်မ Configuration ဖိုင် (Container ၄ ခု၏ အချက်အလက်များ ပါဝင်သည်)
├── rclone/
│   └── rclone.conf          # Koofr Cloud နှင့် ချိတ်ဆက်ရန်အတွက် Email နှင့် Obscured Password သိမ်းဆည်းထားသော လုံခြုံရေးဖိုင်
└── vw-data/                 # Vaultwarden ၏ အရေးကြီးဆုံး Data များ အမှန်တကယ် သိမ်းဆည်းထားသော နေရာ
    ├── db.sqlite3           # သင့် Password များအားလုံးကို ကုဒ်ဝှက်၍ သိမ်းထားသော Database ဖိုင်
    ├── rsa_key.pem          # လုံခြုံရေး Key ဖိုင်များ
    ├── attachments/         # သင်သိမ်းဆည်းထားသော ပုံများ၊ ဖိုင်များ
    └── sends/               # Bitwarden Send ဖြင့် ပေးပို့ထားသော အရာများ
```

### ၃။ စနစ်တစ်ခုလုံး အလုပ်လုပ်မှု ရှိ/မရှိ စစ်ဆေးနည်း (Health Checks)

စနစ်ကြီးတစ်ခုလုံး ချောမွေ့စွာ အလုပ်လုပ်နေခြင်း ရှိ/မရှိကို အောက်ပါနည်းလမ်းများဖြင့် အချိန်မရွေး စစ်ဆေးနိုင်ပါသည် -

၁။ **အခြေခံအကျဆုံး စစ်ဆေးခြင်း**
   `docker ps` ဟု ရိုက်ထည့်ပါ။ Container (၄) ခုစလုံး `Up` ဟု ပြနေပါက စနစ်ကြီးတစ်ခုလုံး ကျန်းမာစွာ အလုပ်လုပ်နေပါသည်။

၂။ **အသေးစိတ် အလုပ်လုပ်ပုံ (Log) များအား စစ်ဆေးခြင်း**
   - **Vaultwarden ပင်မစနစ်:** `docker logs vaultwarden` ဟု ရိုက်ပါက Login ဝင်ခြင်း၊ Password အသစ်သိမ်းခြင်း စသည့် လုပ်ဆောင်ချက်များကို မြင်ရပါမည်။
   - **Cloudflare ချိတ်ဆက်မှု:** `docker logs cloudflared` ဟု ရိုက်ပါက `Registered tunnel connection` ဆိုသော စာသားများ တွေ့ရမည်ဖြစ်ပြီး၊ Cloudflare နှင့် ချိတ်ဆက်မှု မပြတ်တောက်ကြောင်း အတည်ပြုနိုင်ပါသည်။
   - **Backup စနစ်:** `docker logs vaultwarden-backup` ဟု ရိုက်ပါ။ ညတိုင်း Backup အောင်မြင်စွာ လုပ်/မလုပ်ကို ၎င်းမှတစ်ဆင့် စစ်ဆေးနိုင်ပါသည်။ (Backup တင်နေစဉ်အတွင်းသာ Log များ ထွက်ပေါ်မည်ဖြစ်သည်)။

> **[!TIP]**
> ဤဖိုင်တွဲဖွဲ့စည်းပုံ (File Structure) အရ၊ သင်သည် VPS အသစ်တစ်ခုသို့ ပြောင်းရွှေ့လိုပါက `~/vaultwarden/` ဖိုင်တွဲတစ်ခုလုံးကို Copy ကူး၍ ဆာဗာအသစ်တွင် သွားထည့်ကာ `docker compose up -d` ဟု ရိုက်လိုက်ရုံဖြင့် အရာအားလုံး (Password များအပါအဝင်) ယခင်အတိုင်း ပြန်လည်ရရှိမည် ဖြစ်ပါသည်။
